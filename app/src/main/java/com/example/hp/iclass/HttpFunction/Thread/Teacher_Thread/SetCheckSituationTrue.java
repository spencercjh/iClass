...
public class SetCheckSituationTrue extends Thread {
    private boolean flag;
    private String url;
    private String subject_id;
    private String upadate_state;

    public SetCheckSituationTrue(String url, String subject_id) {
    ...
    private void doGet() throws IOException {
        ...
        try {
            ...
            if (getUpadate_state().equals("set check_situation true failed")) {
                setFlag(false);
            } else {
                setFlag(true);
            }
