...
public class AddStudentToSubject extends Thread {
    ...
    public AddStudentToSubject(String url, String student_id, String subject_id) {
...
//            URLEncoder.encode(URLEncoder.encode(url));
            ...
            if (state.equals("insert relationship failed")) {
                setFlag(false);
            } else {
                setFlag(true);
            }
