...
public class Seat1Activity_Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seat1_student);
...
//        clear_memory();
    ...
    private void dialog1(final int seat_index) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Seat1Activity_Student.this);
                    ...
                    if (isopencheck()) {
                        ...
                        try {   //尝试签到
                            if (Fun_InsertCheckInfo.http_InsertCheckInfo(insert)) {
                                ...
                                Toast.makeText(Seat1Activity_Student.this, "签到失败！", Toast.LENGTH_SHORT).show();
                            }
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                    } else {
                        Toast.makeText(Seat1Activity_Student.this, "教师还未开始签到！", Toast.LENGTH_SHORT).show();
                    }
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
