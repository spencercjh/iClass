...
public class SetCheckSituationFalse extends Thread {
    private boolean flag;
    private String url;
    private String subject_id;
    private String upadate_state;

    public SetCheckSituationFalse(String url, String subject_id) {
    ...
    private void doGet() throws IOException {
        ...
        try {
            ...
            if (getUpadate_state().equals("set check_situation false failed")) {
                setFlag(false);
            } else {
                setFlag(true);
            }
    ...
    public void setUpadate_state(String upadate_state) {
        this.upadate_state = upadate_state;
    }
