...
public class Seat2Activity_Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seat2_student);
        ...
        if (ischecked()) {
//            Toast.makeText(Seat2Activity_Student.this, "这节课你已经签过了", Toast.LENGTH_SHORT).show();
            Checked_Back();
        } else {
    ...
    private void Student_FillSeatView() {
        ...
        try {
            check_student = Json_CheckInfoList.parserJson(Fun_GetCheckStudent.http_GetCheckStudent(subjectOBJ));
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    if (isopencheck()) {
                        ...
                        Toast.makeText(Seat2Activity_Student.this, "教师还未开始签到！", Toast.LENGTH_SHORT).show();
                    }
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
