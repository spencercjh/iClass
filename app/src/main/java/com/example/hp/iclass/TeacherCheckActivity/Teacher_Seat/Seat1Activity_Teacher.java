                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()) {
                                ...
                                case R.id.menu_quick_minus:
                                    ...
                                    break;
                                case R.id.menu_info:
                                    Intent intent = new Intent(Seat1Activity_Teacher.this, CheckedStudentDetailActivity.class);
...
//        clear_memory();
    ...
    private void dialog1(final int seat_index) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Seat1Activity_Teacher.this);
